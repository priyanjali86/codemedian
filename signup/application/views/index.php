...
<head>
	...
	<link href="<?php echo $baseurl;?>assets/global_assets/css/icons/icomoon/styles.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $baseurl;?>assets/global_assets/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $baseurl;?>assets/global_assets/assets/css/bootstrap_limitless.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $baseurl;?>assets/global_assets/assets/css/layout.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $baseurl;?>assets/global_assets/assets/css/components.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo $baseurl;?>assets/global_assets/assets/css/colors.min.css" rel="stylesheet" type="text/css">
	<!-- /global stylesheets -->

	<!-- Core JS files -->
	<script src="<?php echo $baseurl;?>assets/global_assets/js/main/jquery.min.js"></script>
	<script src="<?php echo $baseurl;?>assets/global_assets/js/main/bootstrap.bundle.min.js"></script>
	<script src="<?php echo $baseurl;?>assets/global_assets/js/plugins/loaders/blockui.min.js"></script>
	<!-- /core JS files -->

	<!-- Theme JS files -->
	<script src="<?php echo $baseurl;?>assets/global_assets/js/plugins/visualization/d3/d3.min.js"></script>
	<script src="<?php echo $baseurl;?>assets/global_assets/js/plugins/visualization/d3/d3_tooltip.js"></script>
	<script src="<?php echo $baseurl;?>assets/global_assets/js/plugins/forms/styling/switchery.min.js"></script>
	<script src="<?php echo $baseurl;?>assets/global_assets/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
	<script src="<?php echo $baseurl;?>assets/global_assets/js/plugins/ui/moment/moment.min.js"></script>
	<script src="<?php echo $baseurl;?>assets/global_assets/js/plugins/pickers/daterangepicker.js"></script>

	<script src="<?php echo $baseurl;?>assets/global_assets/assets/js/app.js"></script>
	<script src="<?php echo $baseurl;?>assets/global_assets/js/demo_pages/dashboard.js"></script>
	<!-- /theme JS files -->
	...
	<div class="navbar navbar-expand-md navbar-dark">
		<div class="navbar-brand">
			<a href="index.html" class="d-inline-block">
				<img src="<?php echo $baseurl;?>assets/global_assets/images/logo_light.png" alt="">
			</a>
		</div>
			...
			<ul class="navbar-nav">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-300">
						...
						<div class="dropdown-content-body dropdown-scrollable">
							<ul class="media-list">
								<li class="media">
									<div class="mr-3">
										<img src="<?php echo $baseurl;?>assets/global_assets/images/demo/users/face18.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-350">
						...
						<div class="dropdown-content-body dropdown-scrollable">
							<ul class="media-list">
								...
								<li class="media">
									<div class="mr-3 position-relative">
										<img src="<?php echo $baseurl;?>assets/global_assets/images/demo/users/face3.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
								...
								<li class="media">
									<div class="mr-3">
										<img src="<?php echo $baseurl;?>assets/global_assets/images/demo/users/face24.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
										<div class="media-title">
											<a href="#">
								...
								<li class="media">
									<div class="mr-3">
										<img src="<?php echo $baseurl;?>assets/global_assets/images/demo/users/face4.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
										<div class="media-title">
											<a href="#">
								...
								<li class="media">
									<div class="mr-3">
										<img src="<?php echo $baseurl;?>assets/global_assets/images/demo/users/face25.jpg" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
										<div class="media-title">
											<a href="#">
				...
				<li class="nav-item dropdown dropdown-user">
					<a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown">
						<img src="<?php echo $baseurl;?>assets/global_assets/images/demo/users/face11.jpg" class="rounded-circle mr-2" height="34" alt="">
						<span>Victoria</span>
					</a>
			...
			<div class="sidebar-content">
				...
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							<div class="mr-3">
								<a href="#"><img src="<?php echo $baseurl;?>assets/global_assets/images/demo/users/face11.jpg" width="38" height="38" class="rounded-circle" alt=""></a>
							</div>
